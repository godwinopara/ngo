...
const DonateCard = ({ img, title, desc, className, btn = "Give Now" }: DonateCardProps) => {
	return (
		<div className="bg-white h-[400px] w-full mb-32 lg:mb-0 lg:mr-10 text-center px-6 py-20 relative last:mr-0">
			<img src={img} alt="" className="absolute w-2/5 -top-[20%] lg:-top-28 left-[28%]" />
