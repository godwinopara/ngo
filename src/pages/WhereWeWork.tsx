				...
				<section>
						...
						<div className="min-h-[70vh] bg-workHero bg-center bg-cover text-center flex items-center text-white">
							<div className="z-20 px-5 lg:px-0">
								...
								<p className="text-xl lg:w-1/2 mx-auto">
									...
									projects and donations of medicine, Souls Aid Global improves the health of
									millions of people affected by poverty, disaster and inequity every year.
								</p>
							</div>
						</div>
					...
					<div className="py-20 bg-gray-100">
						<p className="mx-5 lg:w-3/5 lg:mx-20 text-2xl">
							...
							countries each year. Working with partners, Souls Aid Global carries out health
							programs in 30 countries, including Colombia, El Salvador, Haiti, India, Liberia, the
