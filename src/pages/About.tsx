			...
			<section>
				...
				<div className="max-w-[1000px] mx-auto grid grid-cols-2 gap-28 my-20">
					<div>
						...
						<p className="text-gray-600">
							Humanity First is a non-political, non-religious and impartial international relief
							and development agency that focuses on protecting human life and dignity. Humanity
							First provides aid on the basis of necessity alone, irrespective of caste, creed,
					...
					<div>
						<p className="text-gray-600">
							Established in 1995, Humanity First (‘HF’) was registered with the UK Charities
							...
							quality education to vulnerable communities. Humanity First International became the
							ultimate parent company, its offices are based in London and it is governed by a board
							of trustees. HF is funded by voluntary contributions of individuals and private
							sponsors. Majority of the aid workers and management are unpaid volunteers who
							recognize the significance and value in helping those less fortunate.
						</p>
						<br />
						<p className="text-gray-600">
							Humanity First has consultative status with United Nations Economic and Social Council
							(ECOSOC). HF also works in partnership with many international, regional and local
				...
				<div className="max-w-[1000px] mx-auto ">
					...
					<div className=" grid grid-cols-2 gap-28 mt-10 mb-20">
						<div>
							<p>
								Humanity First began to operate in the early 1990 and was formally established under
								a trust deed as a registered charity with the UK Charities Commission, in
						...
						<div>
							<p>
								In 2019, a separate new entity Humanity First UK was setup to focus on development
								projects in locally and developing countries under the guidance of Humanity First
				...
				<div className="max-w-[1000px] mx-auto ">
					...
					<div className=" grid grid-cols-2 gap-28 mt-10 mb-20">
						<div>
							<p>
								The regional Humanity First teams aim to deliver outcomes to help low income and
								vulnerable communities free themselves from poverty. Collaboration is important to
								Humanity First as certain organizations expertise in certain areas. It is important
				...
				<div className="max-w-[1000px] mx-auto mb-20">
					...
					<div className="mb-20">
						...
						<p>
							Humanity First International is responsible for providing policies, general guidance,
							strategy and a complete framework of operations to all its affiliates across the
							globe. It is responsible for new setups and coordinates relief activities during major
							disasters. HF ensures effectiveness, efficiency and control in operational financial
							management. Humanity First International has two governing bodies:
						</p>
					</div>
					...
					<div>
						<div className="text-center">
							...
							<p>
								The management of Humanity First International is mainly operated by Health Care
								professionals, Entrepreneurs, Educators, technology expertise and many other
								professionals, all of whom volunteer their time to serve humanity.
							</p>
						</div>
					</div>
				</div>
