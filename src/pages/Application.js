...
const Application = () => {
	...
	return (
		<MainLayout>
			<section className="px-6 py-8 text-[#808080] max-w-[900px] mx-auto">
				<div>
					...
					<form onSubmit={handleSubmit}>
						...
						<div>
							...
							<p>
								...
								this application. Providing this information is optional. It will not be accessible
								or used in the hiring process, and has no effect on your opportunity for employment.
							</p>
